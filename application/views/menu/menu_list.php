		...
		<?php echo anchor(site_url('menu/pdf'), '<i class=\'fa fa-file-excel-o\'></i>PDF', 'class="btn btn-success"'); ?>
                    ...
                    columns: [
                        {
                            "data": "id_menu",
                            "orderable": false
                        },{"data": "id_parent"},{"data": "nama_menu"},{"data": "gambar"},{"data": "icon"},{"data": "link"},{"data": "aktif"},{"data": "urutan"},{"data": "position"},{"data": "level"},
                        {
                            "data" : "action",
                            "orderable": false,
