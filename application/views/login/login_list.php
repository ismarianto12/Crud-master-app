		...
		<?php echo anchor(site_url('login/pdf'), '<i class=\'fa fa-file-excel-o\'></i>PDF', 'class="btn btn-success"'); ?>
                    ...
                    columns: [
                        {
                            "data": "id_user",
                            "orderable": false
                        },{"data": "username"},{"data": "password"},{"data": "nama"},{"data": "level"},{"data": "foto"},{"data": "email"},{"data": "log"},{"data": "aktif"},
                        {
                            "data" : "action",
                            "orderable": false,
